...
def test_length(input_value):
    ...
    assert test_spellcheck.word_count(input_value) < 10
    assert test_spellcheck.char_count(input_value) < 50
...
def test_struc(input_value):
    ...
    """
    ### WRITE SOLUTION CODE HERE
    assert test_spellcheck.first_char(input_value).isupper()
    assert test_spellcheck.last_char(input_value) == "."
