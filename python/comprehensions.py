...
def to_mod_list(employee_list):
   ...
   name_dept = map(mod, employee_list)
   name_dept_list = [x for x in name_dept]

# references
#  https://bobbyhadz.com/blog/python-convert-map-to-list#:~:text=Use%20the%20list()%20class,and%20returns%20a%20list%20object.
#  https://note.nkmk.me/en/python-dict-keys-values-items/

#    name_dept_list=[]
#    print(name_dept)
#    for value in name_dept:
#       print(value)
#       name_dept_list.append(value)

   return name_dept_list
