...
def read_even_numbered_lines(file_name):
    ...
    """
    # WRITE SOLUTION HERE
    file_contents_list = read_file_into_list(file_name)
    ...
    for i in range(0, len(file_contents_list)):
        # print(i)
        if not (i % 2) == 0:
            list_even.append(file_contents_list[i])
            # print(list_even)
...
def main():
    ...
    file_contents_list = read_file_into_list("sampletext.txt")
